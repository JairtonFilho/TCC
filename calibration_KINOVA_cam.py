...
robot_instance = ConnectGen3("172.22.64.105", ["admin", "admin"])
...
# focus = 10  # multiplos de 5
# cap.set(28, focus)
cap.set(3, 1280)
cap.set(4, 720)

cal = calibration('123456789012')
print("A melhor posição obtida foi contador_coluna: " + str(cal))
